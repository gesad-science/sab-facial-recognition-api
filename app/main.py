...
# 🔑 Configure o CORS para permitir requests do seu app Android
app.add_middleware(
    CORSMiddleware,
    allow_origins=["*"],  # Para produção, substitua "*" pela URL exata do seu app
...
#ngrok_tunnel = ngrok.connect(8000, options={"hostname": static_domain})
print('Public URL:', ngrok_tunnel.public_url)  # Anote esta URL HTTPS!
