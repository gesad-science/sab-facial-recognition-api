...
# Vamos redefinir a arquitetura ResNet do seu modelo original
...
def load_model(model_path, class_names_path, device='cpu'):
    """Carrega o modelo fine-tuned e as classes"""
